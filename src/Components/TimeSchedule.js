    ...
    <section id='schedule' className=' w-full'>
      ...
      <div className=' grid grid-cols-5 gap-4 w-[80%] mt-10 max-xl:w-[100%] max-lg:grid-cols-2 max-sm:grid-cols-1 m-auto duration-300'>
          ...
          <div className={` ${active === "5" ? "bg-[red]" : undefined} group hover:bg-[red] px-6 py-10 text-center h-[250px] max-lg:h-[270px] max-sm:h-[250px]`}>
            <p className={` ${active === "5" ? "bg-white text-black" : "text-white"} text-lg bg-black group-hover:bg-white group-hover:text-black text-center max-w-[80%] m-auto py-1 mt-4 max-lg:max-w-[35%]`}>Soon</p>
            <h1 className={`${active === "5" ? "text-white" : undefined} text-black mt-5 group-hover:text-white text-3xl`}>health Talks With Sergen</h1>
            <p className={`${active === "5" ? "text-white" : undefined} text-black group-hover:text-white text-lg`}>by <span className={`${active === "5" ? "text-white" : undefined} text-slate-500 group-hover:text-white`}>Sergen</span></p>
          </div>
